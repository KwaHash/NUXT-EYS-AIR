	...
	<div class="relative overflow-x-clip py-[2vw] md:py-[10px] bottom-[48vw] md:bottom-[245px] hover:cursor-pointer">
		...
		<div class="px-[5.4vw] md:px-[27px] relative top-[-15.3vw] md:top-[-93px]">
			...
			<NuxtImg src="/img/reason/v2/home.webp" loading="lazy"
				class="mt-[34vw] md:mt-[172px] w-full h-[67vw] md:h-[335px] rounded-md shadow-xl" alt="v2-home" />
			<p class="text-white inline-block py-[1.3vw] md:py-[6.5px] pl-[3vw] md:pl-[15px] pr-[3.3vw] md:pr-[15.5px] absolute bottom-[5.6vw] md:bottom-[28px] text-[5.4vw] md:text-[27px] tracking-tight font-bold"
